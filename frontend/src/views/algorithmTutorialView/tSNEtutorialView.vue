<template>
    <div class="experiment-container">
        ...
        <div class="experiment-content">
            <keep-alive>
                <component :is="currentComponent" @step-completed="nextStep" tutorialType="tSNE" algorithmType="tSNE">
                </component>
            </keep-alive>
        </div>
...
<script>
import TutorialComponent from '@/components/InteractiveTutorials/tSNEtutorial/TsneTutorial.vue';
