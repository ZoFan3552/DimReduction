<template>
    <div class="experiment-container">
        ...
        <!-- 实验进度条 -->
        <!-- <el-steps :active="currentStep" simple class="experiment-steps">
        ...
        <!-- <div class="experiment-controls">
            <el-button type="primary" @click="prevStep" :disabled="currentStep <= 0">
                上一步
            </el-button>
            <el-button type="primary" @click="nextStep" :disabled="currentStep >= steps.length - 1">
                下一步
            </el-button>
            <el-button type="success" @click="completeExperiment" v-if="currentStep === steps.length - 1">
                完成实验
            </el-button>
        </div> -->
    </div>
...
<script>
import TutorialComponent from '@/components/InteractiveTutorials/PCAtutorial/PCAtutorial.vue';
    ...
    data() {
        return {
            ...
            steps: [
                ...
                // { title: '结果分析', component: 'TutorialComponent' }
            ],
            componentMap: {
